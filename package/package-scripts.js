...
scripts.build = {
  stylesheets: `npx sass ${configPaths.scssPath}:${configPaths.stylesheetsOutputPath} --load-path=${configPaths.govukFrontendPath} --load-path=${configPaths.digitalLandFrontendPath}`,
